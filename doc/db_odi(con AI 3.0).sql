...
/* Created on:     04/07/2024 05:05:21 p.m.                     */
/*==============================================================*/
...
create table CONTIENE (
   CD_OBJ               INT4                 not null,
   CD_COMP              INT4                 not null,
   ID_USUARIO           INT4                 not null,
   ID_PLANILLA_ADMINISTRATIVO INT4                 not null,
...
create table FACTORES_DE_EVALUACION (
   ID_FE                SERIAL               not null,
   ID_USUARIO           INT4                 null,
   ID_PLANILLA_OBRERO   INT4                 null,
...
create table OBJETIVOS (
   CD_OBJ               SERIAL               not null,
   NOMBRE_OBJETIVO      TEXT                 null,
   AREA_OBJETIVOS       TEXT                 null,
...
create table PLANILLA_ADMINISTRATIVO (
   ID_USUARIO           INT4                 not null,
   ID_PLANILLA_ADMINISTRATIVO SERIAL               not null,
...
create table PLANILLA_OBRERO (
   ID_USUARIO           INT4                 not null,
   ID_PLANILLA_OBRERO   SERIAL               not null,
...
create table RANGO_DE_EVALUACION (
   ID_RANGO_EVALUACION  SERIAL               not null,
   ID_USUARIO           INT4                 not null,
   ID_PLANILLA_ADMINISTRATIVO INT4                 not null,
   CALIF_TOTAL_A        NUMERIC              null,
   CALIF_TOTAL_B        NUMERIC              null,
   CALIF_CALIFICACION_FINAL NUMERIC              null,
   RANGO_ACTUACION      TEXT                 null,
