function IngresarFactor(){
    ...
    var dataFormulario = capturarValoresFormulario('form_Factor');
...
function listarFactores(){
  ...
  procesar('http://localhost/ODI/controlador/?Serv_listar_Factores','listarFactores(respuestaServidor)');
}

function listarFactores(respuestaServidor){
